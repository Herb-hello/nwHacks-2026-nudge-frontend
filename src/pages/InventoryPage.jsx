      ...
      <div className="px-10 pt-16">
        ...
        <div className="relative mb-6">
          ...
          <div className="absolute top-4 right-4 bg-white px-2.5 py-1.5 rounded-md border-[1.5px] border-black flex items-center gap-2">
            <span className="text-sm font-['Space_Grotesk']">{selectedFeed}</span>
            <span className="text-sm font-['Space_Grotesk']">^</span>
          </div>
        </div>

        {/* Inventory Header */}
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-3xl font-bold font-['Space_Grotesk'] text-black">
            Inventory
          </h2>
          <button 
          ...
          >
            <span className="text-base font-medium font-['Space_Grotesk'] text-black">
              Add Item
            </span>
        ...
        <div className="flex gap-3 mb-6">
          ...
          >
            <span className="text-base font-['Space_Grotesk'] text-black">
              3 days left
            </span>
          </button>
          ...
          {filteredItems.map(item => (
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-base font-bold font-['Space_Grotesk'] text-black">
                    {item.name}
                  </p>
                </div>
              </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-6 w-full max-w-sm">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-xl font-bold font-['Space_Grotesk']">Add New Item</h3>
