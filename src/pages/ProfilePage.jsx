  ...
  return (
    <div className="w-[430px] h-[932px] bg-white relative overflow-y-auto mx-auto pb-20" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
      ...
      <div className="px-10 pt-16">
        ...
        {/* Li Household Card */}
        <div className="w-80 bg-white rounded-2xl shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] border border-black p-6 mb-6">
          <div className="flex justify-between items-start mb-4">
            <h3 className="text-2xl font-bold text-black">
              Li Household
            </h3>
            <button className="bg-neutral-200 px-4 py-1 rounded-full">
              <span className="text-base font-normal text-black">Manage</span>
            </button>
          </div>
        ...
        {/* Vegetarian Card */}
        <div className="w-80 rounded-2xl shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] border border-black p-4 mb-6 flex justify-between items-center" style={{ backgroundColor: '#FCE7AA' }}>
          <h3 className="text-2xl font-bold text-black">Vegetarian</h3>
          <button className="px-4 py-1 rounded-full" style={{ backgroundColor: '#F5CF64' }}>
            <span className="text-base font-normal text-black">Edit</span>
          </button>
        </div>

        {/* Allergies Card */}
        <div className="w-80 rounded-2xl shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] border border-black p-6 mb-8" style={{ backgroundColor: '#FCE7AA' }}>
          <div className="flex justify-between items-start mb-4">
        ...
        {/* Routine Card */}
        <div className="w-80 bg-white rounded-2xl shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] border border-black p-4 flex items-center gap-4 mb-6">
