  ...
  const handleAddItem = () => {
    if (newItem.name.trim()) {
      const item = {
        ...
        name: newItem.name,
        daysLeft:
          newItem.type === "fridge" && newItem.daysLeft
            ? parseInt(newItem.daysLeft)
            : undefined,
        type: newItem.type,
        expired: false,
      };
        ...
        <div className="relative w-full h-full bg-white overflow-hidden">
          ...
          >
            <div className="flex flex-col px-10 pt-16 pb-6 w-full">
              ...
              <h1 className="text-3xl font-bold text-black mb-4">Live View</h1>
              ...
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-3xl font-bold text-black">Inventory</h2>
                <button
                ...
                >
                  ...
                  >
                    ...
                    <defs>
                      ...
                      >
                        <use
                          xlinkHref="#image0_add"
                          transform="matrix(0.0111111 0 0 0.00864198 0 0.111111)"
                        />
                      </pattern>
                      <image
                        id="image0_add"
              ...
              <div className="gap-3 flex justify-center mb-5">
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-full whitespace-nowrap ${
                    filter === "3days" ? "bg-[#A0A0A0]" : "bg-[#F5F5F5]"
                  }`}
                >
                  <span
                    className={`text-base text-black ${
                      filter === "3days" ? "font-bold" : "font-normal"
                    }`}
                  >
                    3 days left
                  </span>
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-full whitespace-nowrap ${
                    filter === "7days" ? "bg-[#A0A0A0]" : "bg-[#F5F5F5]"
                  }`}
                >
                  <span
                    className={`text-base text-black ${
                      filter === "7days" ? "font-bold" : "font-normal"
                    }`}
                  >
                    7 days left
                  </span>
              ...
              <div>
                ...
                <div className="flex gap-3">
                  <button
                    type="button"
                    onClick={() =>
                      setNewItem({ ...newItem, type: "fridge", daysLeft: "" })
                    }
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      setNewItem({ ...newItem, type: "pantry", daysLeft: "" })
                    }
                    className={`flex-1 px-4 py-2 rounded-lg border-2 font-medium ${
                      newItem.type === "pantry"
                        ? "border-orange-300 bg-orange-50"
